/*
The "CREATE" command is used to create database objects in SQL.
...
The third and last column is called "last_name"; its data type is "VARCHAR(50)" and it has a constraint called "NULL", which means this value can be empty.
...
There are many constraints available. The main goal here is to understand how the "CREATE" command works, but feel free to look up the other constraints and try applying them to a column.
*/
